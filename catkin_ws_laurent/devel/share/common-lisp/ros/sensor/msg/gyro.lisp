...
(cl:defmethod cl:initialize-instance :after ((m <gyro>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gyro)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor-msg:<gyro> is deprecated: use sensor-msg:gyro instead.")))

(cl:ensure-generic-function 'gyro-val :lambda-list '(m))
(cl:defmethod gyro-val ((m <gyro>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor-msg:gyro-val is deprecated.  Use sensor-msg:gyro instead.")
  (gyro m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<gyro>)))
  ...
  "e30554e43a74429ffbf966ec16995406")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'gyro)))
  "Returns md5sum for a message object of type 'gyro"
  "e30554e43a74429ffbf966ec16995406")
