...
(cl:defmethod cl:initialize-instance :after ((m <raw_barometer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'raw_barometer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name th_messages-msg:<raw_barometer> is deprecated: use th_messages-msg:raw_barometer instead.")))
