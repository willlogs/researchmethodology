...
(cl:defmethod cl:initialize-instance :after ((m <raw_imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'raw_imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name th_messages-msg:<raw_imu> is deprecated: use th_messages-msg:raw_imu instead.")))
...
(cl:defmethod sensor_id-val ((m <raw_imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader th_messages-msg:sensor_id-val is deprecated.  Use th_messages-msg:sensor_id instead.")
  (sensor_id m))
